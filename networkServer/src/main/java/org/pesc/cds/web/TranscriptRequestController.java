...
// @Api(tags = "Transcript Requests", description = "Manage transcript
/// requests.")
// public class TranscriptRequestController {
//
// private static final Log log =
/// LogFactory.getLog(TranscriptRequestController.class);
//
// @Autowired
...
//
// private String getEmailAddress(final JSONObject edexOrganization) throws
/// JSONException {
...
// */
// private void constructTranscriptRequestSource(final TranscriptRequestBuilder
/// builder, final RequestingSchoolDTO schoolDTO, final JSONObject
/// edexOrganization)
// throws JSONException {
//
// Map<SchoolCodeType, String> schoolCodes = Maps.newHashMap();
//
// SchoolCodeType srcSchoolCodeType =
/// SchoolCodeType.valueOf(schoolDTO.getSchoolCodeType());
// schoolCodes.put(srcSchoolCodeType, schoolDTO.getSchoolCode());
//
//
// List<String> organizationNames =
/// Arrays.asList(edexOrganization.getString("name"));
// List<String> addresses = Arrays.asList(edexOrganization.getString("street"));
// String city = edexOrganization.getString("city");
// StateProvinceCodeType stateProvinceCode =
/// StateProvinceCodeType.valueOf(edexOrganization.getString("state"));
// String postalCode = edexOrganization.getString("zip");
// org.pesc.sdk.sector.academicrecord.v1_9.ObjectFactory
/// academicRecordObjectFactory = new
/// org.pesc.sdk.sector.academicrecord.v1_9.ObjectFactory();
...
/// academicRecordObjectFactory = new
/// org.pesc.sdk.sector.academicrecord.v1_9.ObjectFactory();
// PhoneType phone = academicRecordObjectFactory.createPhoneType();//Provided by
/// Source Institution - optional
// if(StringUtils.isNotBlank(phoneNumber)) {
// int extensionIndex = StringUtils.indexOfIgnoreCase(phoneNumber, "x");//has
/// extension?
// if(extensionIndex!=-1) {
...
// String areaCode =
/// phoneNumber.length()>10?phoneNumber.substring(phoneNumber.length()-10,
/// phoneNumber.length()-7):phoneNumber.substring(0, phoneNumber.length()-7);
...
// }
//
// private TranscriptRequestBuilder constructStudent(final
/// TranscriptRequestBuilder builder, final TranscriptRequestDTO
/// transcriptRequestDTO, final RecordHolderDTO schoolDTO, final JSONObject
/// edexOrganization) {
...
// String trStudentReleasedMethod =
/// transcriptRequestDTO.getStudentReleasedMethod();
...
// currentlyAttendedSchoolCodes.put(srcSchoolCodeType,
...
// * @throws JSONException
// */
// private void constructTranscriptRequestDestination(final
/// TranscriptRequestBuilder builder, final RecordHolderDTO schoolDTO, final
...
// Preconditions.checkArgument(StringUtils.isNotBlank(schoolDTO.getSchoolCode()),
...
// return
/// organizationService.getOrganization(Integer.valueOf(schoolDTO.getSchoolCode()));
// }
// return organizationService.getOrganization(schoolDTO.getSchoolCode(),
/// schoolDTO.getSchoolCodeType());
//
// }
//
// @RequestMapping(method= RequestMethod.POST)
// @ResponseBody
// public List<Transaction> transcriptRequest( @RequestBody final
/// TranscriptRequestDTO transcriptRequestDTO
// ) throws JSONException {
//
// Preconditions.checkArgument(transcriptRequestDTO.getDestinationInstitutions().size()
/// == 1) ;
// Preconditions.checkArgument(transcriptRequestDTO.getSourceInstitutions().size()
/// == 1);
//
...
//
// //The receiving institution information in terms of the transcript. For the
/// transcript request,
// //this will be the opposite---it will be the sending/originating institution.
// RequestingSchoolDTO transcriptRequestor =
/// transcriptRequestDTO.getDestinationInstitutions().get(0);
// RecordHolderDTO recordHolderInstitution =
/// transcriptRequestDTO.getSourceInstitutions().get(0);
//
// List<String> transcriptRequestRecordHolderNames =
/// Lists.newArrayList();//Provided by Source Institution
//
// //Create a transaction to track the transcript request.
//
// Transaction tx = new Transaction();
//
// //Get the endpoint for the record holder. This is where the transcript
/// request will be sent.
// String endpointURI =
/// organizationService.getEndpointURIForSchool(recordHolderInstitution.getSchoolCode(),
/// recordHolderInstitution.getSchoolCodeType(), fileFormat,
// documentType, department, tx, transcriptRequestRecordHolderNames,
/// transcriptRequestDTO.getMode());
//
//
// if (endpointURI == null) {
...
// DocumentTypeCodeType trDocumentTypeCode =
/// DocumentTypeCodeType.STUDENT_REQUEST;
...
// //destination
//
// //trDestinationSchoolCodes.put(SchoolCodeType.MutuallyDefined,
/// String.valueOf(tx.getSenderId()));
// //document
...
//
//
// constructStudent(builder,transcriptRequestDTO,
/// recordHolderInstitution,recordHolderOrg);
//
// constructTranscriptRequestDestination(builder, recordHolderInstitution,
/// recordHolderOrg);
//
...
// tx.setError(message + ". " + String.format("file %s already exists",
/// trFileName));
// }else {
...
// sendDocument(requestFile, endpointURI, tx, fileFormat,documentType,
/// department);
// }
// } catch (Exception e) {
//
...
//
//
// private void sendDocument(final File outboxFile, final String endpointURI,
/// final Transaction tx, final String fileFormat, final String documentType,
/// final String department) throws IOException {
//
// byte[] fileSignature = pkiService.createDigitalSignature(new
/// FileInputStream(outboxFile), pkiService.getSigningKeys().getPrivate());
// try {
//
...
// (endpointURI, HttpMethod.POST, new
/// org.springframework.http.HttpEntity<Object>(map, headers), String.class);
//
//
// if (response.getStatusCode() != HttpStatus.OK) {
// throw new IllegalArgumentException("Failed to send document. Reason: " +
...
//
// //Force the OAuth client to retrieve the token again whenever it is used
/// again.
//
...
//
// @ExceptionHandler
// void handleIllegalArgumentException(final IllegalArgumentException e, final
